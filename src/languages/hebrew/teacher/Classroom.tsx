...
import { buildDailyPlan, planMinutes, type PlanEntry } from '@he/teacher/plan';
import { classroomMood } from '@he/teacher/persona';
import { SKILL_LABEL, readPlacement, type PlacementResult, type SkillId } from '@he/teacher/placement';
import { TeacherChat } from '@he/teacher/TeacherChat';
import { Homework } from '@he/teacher/Homework';
...
export function Classroom({
  ...
  /*
   * Adresler DİL ÖNEKLİ. Bu ekran önek yokken yazıldı ve hedefleri
   * '/ogretmen/...' diye veriyor; önek eklenmeseydi her tıklama önce
   * bulunamayan bir adrese, oradan da ana sayfaya düşerdi.
   */
    ...
    <section className="space-y-8">
      ...
      <section className="card space-y-3 p-5">
        <div className="flex flex-wrap items-baseline gap-2">
          ...
          <button
            type="button"
            onClick={() => navigate(yol('ogretmen/seviye-tespit'))}
                ...
                {inGroup.map((m) => {
                  ...
                  return (
                    <li key={m.id}>
                      <button
                        type="button"
                        onClick={() => navigate(yol(`ogretmen/${m.id}`))}
