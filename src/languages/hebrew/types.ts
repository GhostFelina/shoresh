...
/**
 * CEFR ÇEKİRDEKTEN geliyor, burada tanımlı değil.
 *
 * Avrupa seviye ölçeği İbraniceye ait bir şey değil; Korece de aynı
 * ölçeği kullanacak. Burada tanımlı kalsaydı ödül motoru ve tekrar
 * programı bir DİL MODÜLÜNE bağımlı olurdu.
 *
 * Yeniden ihraç ediliyor ki İbranice dosyaları tek bir yerden tip
 * almaya devam etsin.
 */
