...
import { CATALOG_STATS, CATALOG_ISSUES } from '@he/data/catalog';
import { WRITTEN_SENTENCE_COUNT } from '@he/data/sentences';
...
import { LETTERS_ALPHABETIC } from '@he/data/alefbet';
  ...
  return (
    <section className="card space-y-3 p-5">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Link to={yol('ilerleme')} className="card-2 px-4 py-2 text-sm card-interactive">
          İlerlemeyi gör
        </Link>
      </div>
    </section>
