...
import { VERBS, formCount } from '@he/data/catalog';
import { PHRASES } from '@he/data/phrases';
import { generateSentence } from '@he/engine/sentence';
import { speak } from '@/lib/speech';
import { HEBREW_LEVELS as LEVELS } from '@he/index';
    ...
    <li className="card-2 overflow-hidden">
      ...
      {open && (
        <div className="space-y-2 border-t px-3 py-3">
          ...
          <Link
            to={yol(`verb?v=${encodeURIComponent(verb.id)}`)}
