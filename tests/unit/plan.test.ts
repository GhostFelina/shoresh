...
import { PLAN_MAX, buildDailyPlan, planMinutes, type PlanInput } from '@/features/teacher/plan';
import { availableLessons, type LessonProgress } from '@/features/teacher/lesson';
